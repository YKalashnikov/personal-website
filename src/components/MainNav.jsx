...
import { FaMapMarker, FaEnvelopeO, FaGroup, FaWrench, FaChevronDown, FaChevronUp } from 'react-icons/lib/fa';
  ...
  constructor(props) {
    ...
    this.state = {
      links: [
        ...
        { to: '/projects/', text: 'Projects', icon: FaGroup },
        { to: '/hobbies/', text: 'Hobbies', icon: MdNaturePeople },
        { to: '/terminal/', text: 'Terminal', icon: GoTerminal },
